...
import { LayoutDashboard, Users, CheckSquare, RefreshCw, Network, Settings, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function Sidebar({ onNavigate }: SidebarProps = {}) {
  ...
  const navItems = [
    ...
    { path: "/graph", label: t("nav_graph"), icon: Network },
